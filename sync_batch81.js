...
const ids = [2126, 2127, 2128, 2129, 2131];

async function syncBatch81() {
  ...
  console.log(`\n🎉 Batch 81 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch81().catch(err => { console.error('❌ Error:', err); process.exit(1); });
