...
const ids = [2212, 2213, 2214, 2215, 2216];

async function syncBatch98() {
  ...
  console.log(`\n🎉 Batch 98 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch98().catch(err => { console.error('❌ Error:', err); process.exit(1); });
