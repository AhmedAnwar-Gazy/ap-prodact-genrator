...
const ids = [1743, 1744, 1745, 1746, 1748];

async function syncBatch10() {
  ...
  console.log(`\n🎉 Batch 10 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch10().catch(err => { console.error('❌ Error:', err); process.exit(1); });
