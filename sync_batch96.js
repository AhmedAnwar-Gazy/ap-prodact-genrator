...
const ids = [2202, 2203, 2204, 2205, 2206];

async function syncBatch96() {
  ...
  console.log(`\n🎉 Batch 96 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch96().catch(err => { console.error('❌ Error:', err); process.exit(1); });
