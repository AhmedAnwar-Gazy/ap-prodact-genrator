...
const ids = [2116, 2117, 2118, 2119, 2120];

async function syncBatch79() {
  ...
  console.log(`\n🎉 Batch 79 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch79().catch(err => { console.error('❌ Error:', err); process.exit(1); });
