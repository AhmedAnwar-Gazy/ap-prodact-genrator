...
const ids = [1700, 1702, 1703, 1704, 1705];
...
async function syncBatch4() {
  ...
  console.log(`\n🎉 Batch 4 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch4().catch(err => { console.error('❌ Error:', err); process.exit(1); });
