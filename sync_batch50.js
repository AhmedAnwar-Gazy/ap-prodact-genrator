...
const ids = [1963, 1964, 1965, 1966, 1967];

async function syncBatch50() {
  ...
  console.log(`\n🎉 Batch 50 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch50().catch(err => { console.error('❌ Error:', err); process.exit(1); });
