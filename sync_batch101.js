...
const ids = [2232, 2233, 2234, 2235, 2236];

async function syncBatch101() {
  ...
  console.log(`\n🎉 Batch 101 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch101().catch(err => { console.error('❌ Error:', err); process.exit(1); });
