...
const ids = [1769, 1770, 1773, 1774, 1776];

async function syncBatch14() {
  ...
  console.log(`\n🎉 Batch 14 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch14().catch(err => { console.error('❌ Error:', err); process.exit(1); });
