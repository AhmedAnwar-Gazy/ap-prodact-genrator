...
const ids = [2003, 2004, 2005, 2006, 2007];

async function syncBatch58() {
  ...
  console.log(`\n🎉 Batch 58 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch58().catch(err => { console.error('❌ Error:', err); process.exit(1); });
