...
const ids = [1968, 1969, 1970, 1971, 1972];

async function syncBatch51() {
  ...
  console.log(`\n🎉 Batch 51 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch51().catch(err => { console.error('❌ Error:', err); process.exit(1); });
