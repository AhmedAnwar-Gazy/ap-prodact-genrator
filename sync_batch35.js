...
const ids = [1887, 1888, 1889, 1890, 1891];

async function syncBatch35() {
  ...
  console.log(`\n🎉 Batch 35 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch35().catch(err => { console.error('❌ Error:', err); process.exit(1); });
