...
const ids = [2172, 2173, 2174, 2175, 2176];

async function syncBatch90() {
  ...
  console.log(`\n🎉 Batch 90 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch90().catch(err => { console.error('❌ Error:', err); process.exit(1); });
