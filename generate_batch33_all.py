import json, os
from build_batch33 import create_product_1876, create_product_1877, create_product_1878, create_product_1879, create_product_1880
...
for pdata in products:
    ...
    print(f"Product {pid}: H2={ar_h2}, SpecsTr={ar_tr}, KB_H3={ar_kb}, AR_FAQs={ar_faqs_cnt}, EN_FAQs={en_faqs_cnt}")

print("\nBatch 33 all products generated!")
