...
const ids = [1912, 1913, 1914, 1915, 1916];

async function syncBatch40() {
  ...
  console.log(`\n🎉 Batch 40 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch40().catch(err => { console.error('❌ Error:', err); process.exit(1); });
