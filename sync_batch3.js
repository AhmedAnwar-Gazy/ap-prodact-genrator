...
const ids = [1692, 1694, 1696, 1698, 1699];
...
async function syncBatch3() {
  ...
  console.log(`\n🎉 Batch 3 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch3().catch(err => { console.error('❌ Error:', err); process.exit(1); });
