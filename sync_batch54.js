...
const ids = [1983, 1984, 1985, 1986, 1987];

async function syncBatch54() {
  ...
  console.log(`\n🎉 Batch 54 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch54().catch(err => { console.error('❌ Error:', err); process.exit(1); });
