...
const ids = [1810, 1811, 1812, 1813, 1814];

async function syncBatch21() {
  ...
  console.log(`\n🎉 Batch 21 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch21().catch(err => { console.error('❌ Error:', err); process.exit(1); });
