...
const ids = [1711, 1713, 1714, 1717, 1726];
...
async function syncBatch6() {
  ...
  console.log(`\n🎉 Batch 6 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch6().catch(err => { console.error('❌ Error:', err); process.exit(1); });
