...
const ids = [1958, 1959, 1960, 1961, 1962];

async function syncBatch49() {
  ...
  console.log(`\n🎉 Batch 49 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch49().catch(err => { console.error('❌ Error:', err); process.exit(1); });
