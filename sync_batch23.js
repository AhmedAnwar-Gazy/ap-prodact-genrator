...
const ids = [1820, 1821, 1822, 1823, 1824];

async function syncBatch23() {
  ...
  console.log(`\n🎉 Batch 23 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch23().catch(err => { console.error('❌ Error:', err); process.exit(1); });
