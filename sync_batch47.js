...
const ids = [1948, 1949, 1950, 1951, 1952];

async function syncBatch47() {
  ...
  console.log(`\n🎉 Batch 47 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch47().catch(err => { console.error('❌ Error:', err); process.exit(1); });
