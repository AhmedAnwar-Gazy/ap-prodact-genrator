...
const ids = [2083, 2084, 2085, 2086, 2087];

async function syncBatch73() {
  ...
  console.log(`\n🎉 Batch 73 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch73().catch(err => { console.error('❌ Error:', err); process.exit(1); });
