...
const ids = [2197, 2198, 2199, 2200, 2201];

async function syncBatch95() {
  ...
  console.log(`\n🎉 Batch 95 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch95().catch(err => { console.error('❌ Error:', err); process.exit(1); });
