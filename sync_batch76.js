...
const ids = [2099, 2100, 2101, 2102, 2103];

async function syncBatch76() {
  ...
  console.log(`\n🎉 Batch 76 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch76().catch(err => { console.error('❌ Error:', err); process.exit(1); });
