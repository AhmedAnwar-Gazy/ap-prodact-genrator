...
const ids = [1907, 1908, 1909, 1910, 1911];

async function syncBatch39() {
  ...
  console.log(`\n🎉 Batch 39 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch39().catch(err => { console.error('❌ Error:', err); process.exit(1); });
