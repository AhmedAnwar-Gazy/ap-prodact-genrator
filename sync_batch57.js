...
const ids = [1998, 1999, 2000, 2001, 2002];

async function syncBatch57() {
  ...
  console.log(`\n🎉 Batch 57 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch57().catch(err => { console.error('❌ Error:', err); process.exit(1); });
