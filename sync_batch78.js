...
const ids = [2110, 2111, 2112, 2113, 2115];

async function syncBatch78() {
  ...
  console.log(`\n🎉 Batch 78 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch78().catch(err => { console.error('❌ Error:', err); process.exit(1); });
