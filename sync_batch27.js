...
const ids = [1841, 1842, 1843, 1844, 1845];

async function syncBatch27() {
  ...
  console.log(`\n🎉 Batch 27 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch27().catch(err => { console.error('❌ Error:', err); process.exit(1); });
