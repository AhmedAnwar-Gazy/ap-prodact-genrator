...
const ids = [2147, 2148, 2149, 2150, 2151];

async function syncBatch85() {
  ...
  console.log(`\n🎉 Batch 85 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch85().catch(err => { console.error('❌ Error:', err); process.exit(1); });
