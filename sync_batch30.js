...
const ids = [1856, 1857, 1858, 1859, 1860];

async function syncBatch30() {
  ...
  console.log(`\n🎉 Batch 30 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch30().catch(err => { console.error('❌ Error:', err); process.exit(1); });
