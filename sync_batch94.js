...
const ids = [2192, 2193, 2194, 2195, 2196];

async function syncBatch94() {
  ...
  console.log(`\n🎉 Batch 94 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch94().catch(err => { console.error('❌ Error:', err); process.exit(1); });
