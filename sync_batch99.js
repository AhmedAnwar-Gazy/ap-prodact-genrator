...
const ids = [2217, 2218, 2219, 2220, 2221];

async function syncBatch99() {
  ...
  console.log(`\n🎉 Batch 99 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch99().catch(err => { console.error('❌ Error:', err); process.exit(1); });
