...
const ids = [1800, 1801, 1802, 1803, 1804];

async function syncBatch19() {
  ...
  console.log(`\n🎉 Batch 19 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch19().catch(err => { console.error('❌ Error:', err); process.exit(1); });
