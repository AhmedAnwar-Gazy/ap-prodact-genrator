...
const ids = [2162, 2163, 2164, 2165, 2166];

async function syncBatch88() {
  ...
  console.log(`\n🎉 Batch 88 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch88().catch(err => { console.error('❌ Error:', err); process.exit(1); });
