...
const ids = [2207, 2208, 2209, 2210, 2211];

async function syncBatch97() {
  ...
  console.log(`\n🎉 Batch 97 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch97().catch(err => { console.error('❌ Error:', err); process.exit(1); });
