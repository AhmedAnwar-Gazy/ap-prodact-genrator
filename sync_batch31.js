...
const ids = [1861, 1862, 1865, 1867, 1869];

async function syncBatch31() {
  ...
  console.log(`\n🎉 Batch 31 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch31().catch(err => { console.error('❌ Error:', err); process.exit(1); });
