...
const ids = [1763, 1764, 1766, 1767, 1768];

async function syncBatch13() {
  ...
  console.log(`\n🎉 Batch 13 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch13().catch(err => { console.error('❌ Error:', err); process.exit(1); });
