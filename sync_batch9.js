...
const ids = [1738, 1739, 1740, 1741, 1742];

async function syncBatch9() {
  ...
  console.log(`\n🎉 Batch 9 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch9().catch(err => { console.error('❌ Error:', err); process.exit(1); });
