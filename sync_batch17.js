...
const ids = [1789, 1790, 1791, 1792, 1794];

async function syncBatch17() {
  ...
  console.log(`\n🎉 Batch 17 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch17().catch(err => { console.error('❌ Error:', err); process.exit(1); });
