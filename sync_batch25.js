...
const ids = [1830, 1831, 1833, 1834, 1835];

async function syncBatch25() {
  ...
  console.log(`\n🎉 Batch 25 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch25().catch(err => { console.error('❌ Error:', err); process.exit(1); });
