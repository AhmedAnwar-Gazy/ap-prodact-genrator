...
const ids = [2222, 2223, 2224, 2226, 2228];

async function syncBatch100() {
  ...
  console.log(`\n🎉 Batch 100 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch100().catch(err => { console.error('❌ Error:', err); process.exit(1); });
