...
const ids = [1733, 1734, 1735, 1736, 1737];

async function syncBatch8() {
  ...
  console.log(`\n🎉 Batch 8 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch8().catch(err => { console.error('❌ Error:', err); process.exit(1); });
