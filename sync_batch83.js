...
const ids = [2137, 2138, 2139, 2140, 2141];

async function syncBatch83() {
  ...
  console.log(`\n🎉 Batch 83 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch83().catch(err => { console.error('❌ Error:', err); process.exit(1); });
