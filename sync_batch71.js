...
const ids = [2071, 2072, 2073, 2074, 2075];

async function syncBatch71() {
  ...
  console.log(`\n🎉 Batch 71 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch71().catch(err => { console.error('❌ Error:', err); process.exit(1); });
