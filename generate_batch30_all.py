import json, os
from build_batch30 import create_product_1856, create_product_1857, create_product_1858, create_product_1859, create_product_1860
...
print("\nBatch 30 all products generated!")
