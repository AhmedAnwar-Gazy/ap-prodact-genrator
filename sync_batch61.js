...
const ids = [2018, 2019, 2020, 2021, 2022];

async function syncBatch61() {
  ...
  console.log(`\n🎉 Batch 61 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch61().catch(err => { console.error('❌ Error:', err); process.exit(1); });
