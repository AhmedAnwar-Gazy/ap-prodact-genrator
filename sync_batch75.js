...
const ids = [2094, 2095, 2096, 2097, 2098];

async function syncBatch75() {
  ...
  console.log(`\n🎉 Batch 75 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch75().catch(err => { console.error('❌ Error:', err); process.exit(1); });
