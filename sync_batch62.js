...
const ids = [2023, 2024, 2025, 2026, 2027];

async function syncBatch62() {
  ...
  console.log(`\n🎉 Batch 62 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch62().catch(err => { console.error('❌ Error:', err); process.exit(1); });
