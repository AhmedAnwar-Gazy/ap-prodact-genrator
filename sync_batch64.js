...
const ids = [2033, 2034, 2035, 2036, 2037];

async function syncBatch64() {
  ...
  console.log(`\n🎉 Batch 64 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch64().catch(err => { console.error('❌ Error:', err); process.exit(1); });
