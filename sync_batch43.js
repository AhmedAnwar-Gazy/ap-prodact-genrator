...
const ids = [1927, 1928, 1929, 1930, 1931];

async function syncBatch43() {
  ...
  console.log(`\n🎉 Batch 43 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch43().catch(err => { console.error('❌ Error:', err); process.exit(1); });
