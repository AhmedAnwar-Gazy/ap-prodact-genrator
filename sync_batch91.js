...
const ids = [2177, 2178, 2179, 2180, 2181];

async function syncBatch91() {
  ...
  console.log(`\n🎉 Batch 91 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch91().catch(err => { console.error('❌ Error:', err); process.exit(1); });
