...
const ids = [1902, 1903, 1904, 1905, 1906];

async function syncBatch38() {
  ...
  console.log(`\n🎉 Batch 38 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch38().catch(err => { console.error('❌ Error:', err); process.exit(1); });
