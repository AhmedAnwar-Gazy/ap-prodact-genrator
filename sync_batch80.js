...
const ids = [2121, 2122, 2123, 2124, 2125];

async function syncBatch80() {
  ...
  console.log(`\n🎉 Batch 80 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch80().catch(err => { console.error('❌ Error:', err); process.exit(1); });
