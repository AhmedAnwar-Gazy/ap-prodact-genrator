...
const ids = [1973, 1974, 1975, 1976, 1977];

async function syncBatch52() {
  ...
  console.log(`\n🎉 Batch 52 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch52().catch(err => { console.error('❌ Error:', err); process.exit(1); });
