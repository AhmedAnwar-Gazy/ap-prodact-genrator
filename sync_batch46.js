...
const ids = [1943, 1944, 1945, 1946, 1947];

async function syncBatch46() {
  ...
  console.log(`\n🎉 Batch 46 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch46().catch(err => { console.error('❌ Error:', err); process.exit(1); });
