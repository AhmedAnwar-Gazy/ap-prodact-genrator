...
const ids = [2182, 2183, 2184, 2185, 2186];

async function syncBatch92() {
  ...
  console.log(`\n🎉 Batch 92 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch92().catch(err => { console.error('❌ Error:', err); process.exit(1); });
