...
const ids = [2132, 2133, 2134, 2135, 2136];

async function syncBatch82() {
  ...
  console.log(`\n🎉 Batch 82 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch82().catch(err => { console.error('❌ Error:', err); process.exit(1); });
