...
const ids = [1978, 1979, 1980, 1981, 1982];

async function syncBatch53() {
  ...
  console.log(`\n🎉 Batch 53 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch53().catch(err => { console.error('❌ Error:', err); process.exit(1); });
