...
const ids = [1815, 1816, 1817, 1818, 1819];

async function syncBatch22() {
  ...
  console.log(`\n🎉 Batch 22 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch22().catch(err => { console.error('❌ Error:', err); process.exit(1); });
