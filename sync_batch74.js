...
const ids = [2088, 2089, 2091, 2092, 2093];

async function syncBatch74() {
  ...
  console.log(`\n🎉 Batch 74 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch74().catch(err => { console.error('❌ Error:', err); process.exit(1); });
