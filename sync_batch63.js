...
const ids = [2028, 2029, 2030, 2031, 2032];

async function syncBatch63() {
  ...
  console.log(`\n🎉 Batch 63 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch63().catch(err => { console.error('❌ Error:', err); process.exit(1); });
