...
const ids = [2152, 2153, 2154, 2155, 2156];

async function syncBatch86() {
  ...
  console.log(`\n🎉 Batch 86 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch86().catch(err => { console.error('❌ Error:', err); process.exit(1); });
