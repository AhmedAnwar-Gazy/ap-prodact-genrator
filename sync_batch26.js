...
const ids = [1836, 1837, 1838, 1839, 1840];

async function syncBatch26() {
  ...
  console.log(`\n🎉 Batch 26 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch26().catch(err => { console.error('❌ Error:', err); process.exit(1); });
