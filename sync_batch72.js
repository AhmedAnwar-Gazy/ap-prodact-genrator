...
const ids = [2076, 2078, 2080, 2081, 2082];

async function syncBatch72() {
  ...
  console.log(`\n🎉 Batch 72 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch72().catch(err => { console.error('❌ Error:', err); process.exit(1); });
