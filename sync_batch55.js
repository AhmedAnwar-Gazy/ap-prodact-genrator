...
const ids = [1988, 1989, 1990, 1991, 1992];

async function syncBatch55() {
  ...
  console.log(`\n🎉 Batch 55 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch55().catch(err => { console.error('❌ Error:', err); process.exit(1); });
