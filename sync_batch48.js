...
const ids = [1953, 1954, 1955, 1956, 1957];

async function syncBatch48() {
  ...
  console.log(`\n🎉 Batch 48 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch48().catch(err => { console.error('❌ Error:', err); process.exit(1); });
