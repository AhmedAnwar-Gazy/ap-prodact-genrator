...
const ids = [1881, 1882, 1883, 1884, 1886];

async function syncBatch34() {
  ...
  console.log(`\n🎉 Batch 34 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch34().catch(err => { console.error('❌ Error:', err); process.exit(1); });
