...
const ids = [2187, 2188, 2189, 2190, 2191];

async function syncBatch93() {
  ...
  console.log(`\n🎉 Batch 93 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch93().catch(err => { console.error('❌ Error:', err); process.exit(1); });
