...
const ids = [2104, 2105, 2107, 2108, 2109];

async function syncBatch77() {
  ...
  console.log(`\n🎉 Batch 77 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch77().catch(err => { console.error('❌ Error:', err); process.exit(1); });
