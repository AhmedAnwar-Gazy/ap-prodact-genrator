...
const ids = [1851, 1852, 1853, 1854, 1855];

async function syncBatch29() {
  ...
  console.log(`\n🎉 Batch 29 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch29().catch(err => { console.error('❌ Error:', err); process.exit(1); });
