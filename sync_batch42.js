...
const ids = [1922, 1923, 1924, 1925, 1926];

async function syncBatch42() {
  ...
  console.log(`\n🎉 Batch 42 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch42().catch(err => { console.error('❌ Error:', err); process.exit(1); });
