...
const ids = [2066, 2067, 2068, 2069, 2070];

async function syncBatch70() {
  ...
  console.log(`\n🎉 Batch 70 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch70().catch(err => { console.error('❌ Error:', err); process.exit(1); });
