...
const ids = [2013, 2014, 2015, 2016, 2017];

async function syncBatch60() {
  ...
  console.log(`\n🎉 Batch 60 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch60().catch(err => { console.error('❌ Error:', err); process.exit(1); });
