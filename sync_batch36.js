...
const ids = [1892, 1893, 1894, 1895, 1896];

async function syncBatch36() {
  ...
  console.log(`\n🎉 Batch 36 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch36().catch(err => { console.error('❌ Error:', err); process.exit(1); });
