...
const ids = [1728, 1729, 1730, 1731, 1732];
...
async function syncBatch7() {
  ...
  console.log(`\n🎉 Batch 7 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch7().catch(err => { console.error('❌ Error:', err); process.exit(1); });
