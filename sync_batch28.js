...
const ids = [1846, 1847, 1848, 1849, 1850];

async function syncBatch28() {
  ...
  console.log(`\n🎉 Batch 28 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch28().catch(err => { console.error('❌ Error:', err); process.exit(1); });
