...
const ids = [1805, 1806, 1807, 1808, 1809];

async function syncBatch20() {
  ...
  console.log(`\n🎉 Batch 20 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch20().catch(err => { console.error('❌ Error:', err); process.exit(1); });
