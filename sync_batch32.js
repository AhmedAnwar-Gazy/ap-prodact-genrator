...
const ids = [1870, 1871, 1873, 1874, 1875];

async function syncBatch32() {
  ...
  console.log(`\n🎉 Batch 32 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch32().catch(err => { console.error('❌ Error:', err); process.exit(1); });
