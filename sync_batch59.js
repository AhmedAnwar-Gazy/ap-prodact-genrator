...
const ids = [2008, 2009, 2010, 2011, 2012];

async function syncBatch59() {
  ...
  console.log(`\n🎉 Batch 59 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch59().catch(err => { console.error('❌ Error:', err); process.exit(1); });
