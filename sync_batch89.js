...
const ids = [2167, 2168, 2169, 2170, 2171];

async function syncBatch89() {
  ...
  console.log(`\n🎉 Batch 89 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch89().catch(err => { console.error('❌ Error:', err); process.exit(1); });
