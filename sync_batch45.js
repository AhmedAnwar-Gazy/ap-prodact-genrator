...
const ids = [1937, 1938, 1939, 1940, 1942];

async function syncBatch45() {
  ...
  console.log(`\n🎉 Batch 45 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch45().catch(err => { console.error('❌ Error:', err); process.exit(1); });
