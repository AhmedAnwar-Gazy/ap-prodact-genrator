...
const ids = [2045, 2046, 2047, 2048, 2049];

async function syncBatch66() {
  ...
  console.log(`\n🎉 Batch 66 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch66().catch(err => { console.error('❌ Error:', err); process.exit(1); });
