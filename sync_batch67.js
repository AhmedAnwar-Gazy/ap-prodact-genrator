...
const ids = [2050, 2051, 2052, 2053, 2054];

async function syncBatch67() {
  ...
  console.log(`\n🎉 Batch 67 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch67().catch(err => { console.error('❌ Error:', err); process.exit(1); });
