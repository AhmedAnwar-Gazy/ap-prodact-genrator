...
const ids = [1825, 1826, 1827, 1828, 1829];

async function syncBatch24() {
  ...
  console.log(`\n🎉 Batch 24 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch24().catch(err => { console.error('❌ Error:', err); process.exit(1); });
