...
const ids = [1932, 1933, 1934, 1935, 1936];

async function syncBatch44() {
  ...
  console.log(`\n🎉 Batch 44 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch44().catch(err => { console.error('❌ Error:', err); process.exit(1); });
