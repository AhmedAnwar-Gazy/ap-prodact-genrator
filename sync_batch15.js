...
const ids = [1777, 1778, 1780, 1781, 1782];

async function syncBatch15() {
  ...
  console.log(`\n🎉 Batch 15 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch15().catch(err => { console.error('❌ Error:', err); process.exit(1); });
