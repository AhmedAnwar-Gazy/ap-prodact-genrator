...
const ids = [1685, 1686, 1689, 1690, 1691];
...
async function syncBatch2() {
  ...
  console.log(`\n🎉 Batch 2 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch2().catch(err => { console.error('❌ Error:', err); process.exit(1); });
