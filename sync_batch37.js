...
const ids = [1897, 1898, 1899, 1900, 1901];

async function syncBatch37() {
  ...
  console.log(`\n🎉 Batch 37 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch37().catch(err => { console.error('❌ Error:', err); process.exit(1); });
