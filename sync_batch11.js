...
const ids = [1749, 1750, 1751, 1752, 1753];

async function syncBatch11() {
  ...
  console.log(`\n🎉 Batch 11 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch11().catch(err => { console.error('❌ Error:', err); process.exit(1); });
