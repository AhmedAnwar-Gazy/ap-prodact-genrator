...
const ids = [1917, 1918, 1919, 1920, 1921];

async function syncBatch41() {
  ...
  console.log(`\n🎉 Batch 41 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch41().catch(err => { console.error('❌ Error:', err); process.exit(1); });
