...
const ids = [1706, 1707, 1708, 1709, 1710];
...
async function syncBatch5() {
  ...
  console.log(`\n🎉 Batch 5 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch5().catch(err => { console.error('❌ Error:', err); process.exit(1); });
