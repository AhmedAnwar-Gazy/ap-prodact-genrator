...
const ids = [1993, 1994, 1995, 1996, 1997];

async function syncBatch56() {
  ...
  console.log(`\n🎉 Batch 56 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch56().catch(err => { console.error('❌ Error:', err); process.exit(1); });
