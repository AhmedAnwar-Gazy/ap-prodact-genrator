...
const ids = [1755, 1757, 1758, 1761, 1762];

async function syncBatch12() {
  ...
  console.log(`\n🎉 Batch 12 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch12().catch(err => { console.error('❌ Error:', err); process.exit(1); });
