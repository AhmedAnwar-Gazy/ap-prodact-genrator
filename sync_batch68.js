...
const ids = [2055, 2057, 2058, 2059, 2060];

async function syncBatch68() {
  ...
  console.log(`\n🎉 Batch 68 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch68().catch(err => { console.error('❌ Error:', err); process.exit(1); });
