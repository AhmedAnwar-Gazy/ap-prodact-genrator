...
const ids = [2157, 2158, 2159, 2160, 2161];

async function syncBatch87() {
  ...
  console.log(`\n🎉 Batch 87 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch87().catch(err => { console.error('❌ Error:', err); process.exit(1); });
