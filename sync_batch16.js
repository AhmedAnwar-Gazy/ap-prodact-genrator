...
const ids = [1783, 1784, 1785, 1787, 1788];

async function syncBatch16() {
  ...
  console.log(`\n🎉 Batch 16 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch16().catch(err => { console.error('❌ Error:', err); process.exit(1); });
