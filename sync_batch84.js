...
const ids = [2142, 2143, 2144, 2145, 2146];

async function syncBatch84() {
  ...
  console.log(`\n🎉 Batch 84 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch84().catch(err => { console.error('❌ Error:', err); process.exit(1); });
