...
const ids = [2038, 2039, 2041, 2042, 2043];

async function syncBatch65() {
  ...
  console.log(`\n🎉 Batch 65 sync complete! ${count} products updated in MySQL database.`);
}

syncBatch65().catch(err => { console.error('❌ Error:', err); process.exit(1); });
